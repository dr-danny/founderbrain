 ...
 */
export interface HexclaveClientConfig { projectId: string; apiUrl: string; publishableClientKey: string | null; }
export interface Config { authMode: "hexclave" | "local-demo"; hexclave: HexclaveClientConfig | null; aiEnabled: boolean; }
