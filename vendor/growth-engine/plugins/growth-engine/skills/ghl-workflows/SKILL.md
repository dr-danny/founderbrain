---
name: ghl-workflows
description: Build the operations engine. Runs a bottleneck diagnostic, names the GoHighLevel snapshot the founder's track decides, and writes all the copy that goes inside it. Both tracks. Trigger on "build my ops engine", "which workflow should I automate", "my bottleneck", "pick a snapshot", "operations engine", or Session 2 homework.
---
